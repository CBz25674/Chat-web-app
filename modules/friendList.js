...
module.exports = async (req, res) => {
    ...
    try {
        ...
        conn.query(pendingSql, pendingUser, async (error, result, field) => {
            ...
            conn.query(pendingSql, user, async (err, result2, fld) => {
                ...
                conn.query(friendSql, [friendUser, req.session.user.username], (e, result3, fd) => {
